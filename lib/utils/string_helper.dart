...
class StringHelper {
  ...
  ///划线价格
  static Widget getSlashPrice(String price, double markSp, double sizeSp,
      {String moneySymbol: "\$ ", Color priceColor: Colors.black}) {
    return Row(
      children: <Widget>[
        Text(
          "$moneySymbol",
  ...
  ///不带钱符号的驼峰价格
  static Widget getCamelPriceWithoutSymbol(
      String price, double intSp, double decimalSp,
    ...
    return Text.rich(TextSpan(
      children: [
        TextSpan(
          ...
          style: TextStyle(
              color: priceColor, fontSize: intSp, fontWeight: FontWeight.bold),
        ),
        TextSpan(
          text: ".",
          style: TextStyle(
  ...
  static Widget getPriceWithoutCamel(
      String price, double markSp, double priceSp,
      {String moneySymbol: "\$ ",
        Color priceColor: Colors.black,
        Color? symbolColor,
    ...
    return Text.rich(TextSpan(children: [
      TextSpan(
        text: "$moneySymbol",
        style: TextStyle(
            color: symbolColor == null ? priceColor : symbolColor,
            fontSize: markSp,
      ...
      TextSpan(
        ...
        style: TextStyle(
            color: priceColor, fontSize: priceSp, fontWeight: fontWeight),
      ),
    ]));
  }

  static Widget getPriceWithoutCamelInt(
      String price, double markSp, double priceSp,
      {String moneySymbol: "\$ ",
        Color priceColor: Colors.black,
        Color? symbolColor,
  ...
  ///美式价格 没有驼峰
  static Widget getUsaStylePrice(
      {required String originPrice,
        String priceTail = "",
        String symbol = "\$",
        Color priceColor = Colors.black,
        ...
        double? priceSize,
        double? symbolSize,
        FontWeight priceWeight = FontWeight.w500,
    ...
    return Text.rich(TextSpan(children: [
      ...
      TextSpan(
        ...
        style: TextStyle(
            color: priceColor, fontSize: priceSize, fontWeight: priceWeight),
      ),
    ]));
  }

  ///with symbol
  static Widget getCamelPrice(
      String price, double markSp, double intSp, double decimalSp,
      {String moneySymbol: "\$ ",
        Color priceColor: Colors.black,
        Color? symbolColor,
    ...
    return Text.rich(TextSpan(
      children: [
        ...
        TextSpan(
          text: "${getDoublePriceInt(double.parse(price))}",
          style: TextStyle(
              color: priceColor, fontSize: intSp, fontWeight: fontWeight),
        ),
        TextSpan(
          text: ".",
          style: TextStyle(
              color: priceColor, fontSize: markSp, fontWeight: fontWeight),
        ),
        TextSpan(
          text: "${getDoublePriceDecimal(double.parse(price))}",
          style: TextStyle(
              color: priceColor, fontSize: decimalSp, fontWeight: fontWeight),
        ),
      ],
    ));
  }
  ...
  static String getDoublePriceDecimal(double price) {
    return price > 0
        ? ((price - price.truncate()).toStringAsFixed(2)).substring(2)
        : "00";
  }
  ...
  /// 字符串等位数加密
  static String formatPassword(String pwd, String replace){
    return pwd.split('').map((e) => replace).toList().join('');
  }
}